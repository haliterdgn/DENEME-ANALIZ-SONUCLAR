...
import { PlusCircle, Users, FileText, BarChart3, Eye } from "lucide-react"
...
import OptikFormTanimla from "./optik-form-tanimla"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <Button onClick={() => setActiveTab("create")} className="w-full justify-start">
